...
public class TestLevel5Test2 {

	public final static String TEST_DIRECTORY = "testdata";
	public final static String TEST_FILE = "test2.l5t2";
	private String _name;
	
	public TestLevel5Test2() {
		_name = TEST_FILE;
	}

	@Test
	public void testGeneratedValidator() {
		org.dimitri_lang.runtime.level3.Validator validator = new LEVEL5Validator();
